...
var pages = {
	en: {
		...
		page4: { 
			title: "Thank you",
			subtitle: "We hope you found these brief videos informative."
		},
		page5: { 
			title: "Thank you",
	...
	es: {
		...
		page4: { 
			title: "Gracias",
			subtitle: "Esperamos que haya encontrado estos breves videos muy informativos."
		},
		page5: { 
			title: "Gracias",
	...
	ru: {
		...
		page4: { 
			title: "Спасибо",
			subtitle: "Мы надеемся, что вы нашли это видео полезным."
		},
		page5: { 
			title: "Спасибо",
	...
	it: {
		...
		page4: { 
			title: "Grazie",
			subtitle: "We hope you found these videos informative."
		},
		page5: { 
			title: "Grazie",
...
function showCurrentVideo() { 
	...
	tip.toggle(typeof kioskpro_id === 'undefined');
	...
	sorry.toggle(page.hasClass("en")==false && typeof kioskpro_id === 'undefined');
}
...
function createMenuPage(lang, pageId) {
	...
	page.find(".save").click(function(event) {
		...
		try {
			if(typeof kioskpro_id !== 'undefined') throw "kioskpro";
